import fotoKayke from "../assets/fotoKayke.jpg";
        ...
        <div className="mt-auto space-y-3">
          ...
          >
            <svg
              ...
              viewBox="0 0 24 24"
              fill="white"
              className="bg-gradient-to-b from-gray-700 to-gray-700/10 p-2 rounded"
            >
            ...
            @kaykedpm
            <svg
              className="fill-white opacity-0 transform -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300"
              width="36"
              height="36"
              viewBox="0 0 24 24"
              xmlns="http://www.w3.org/2000/svg"
